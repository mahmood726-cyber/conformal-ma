        # Conformal Ma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/conformal-ma.git

        ## Objective

        ConformalMA applies conformal prediction to meta-analysis, producing distribution-free prediction intervals with valid finite-sample coverage guarantees across heterogeneous study populations.
        ...
        - Code: https://github.com/mahmood726-cyber/conformal-ma.git
        - Dashboard: https://mahmood726-cyber.github.io/conformal-ma/
